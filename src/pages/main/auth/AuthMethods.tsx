      ...
      <Accordion type="single" collapsible>
        <AccordionItem value="item-1">
          ...
          <AccordionContent className='px-3'>
            ...
            <div>회원 자격 유지와 관리, 서비스 부정이용 방지 목적으로 개인정보를 처리합니다.</div>
            <div>2. 서비스 제공</div>
            <div>콘텐츠 제공, 본인인증의 목적으로 개인정보를 처리합니다.</div>
            <div>3. 서비스 개선 및 분석</div>
            <div>서비스 이용에 대한 분석, 서비스 개선을 목적으로 개인정보를 처리합니다.</div>
            <div>4. 서비스 개발</div>
            <div>기존 서비스와 별개의 신규 서비스 개발 목적으로 개인정보를 처리합니다.</div>
            <div>각각의 개인정보 처리 및 보유 기간은 다음과 같습니다.</div>
            <div>1. 홈페이지 회원 가입: 회원 탈퇴 시까지</div>
            <div>다만, 다음의 사유에 해당하는 경우에는 해당 사유 종료 시까지 보관합니다.</div>
            <div>1. 관계 법령 위반에 따른 수사, 조사 등이 진행 중인 경우에는 해당 수사, 조사 종료 시까지</div>
            <div>쿠우산KHUSAN은 개인정보 보유기간의 경과, 처리목적 달성 등 개인정보가 불필요하게 되었을 떄에는 지체없이 해당 개인정보를 파기합니다.</div>
            <div>쿠우산KHUSAN은 정보주체에게 개별적인 서비스와 편의를 제공하기 위해 이용정보를 저장하고 수시로 불러오는 쿠키를 사용합니다.</div>
            <div>쿠우산KHUSAN은 원활한 개인정보 업무처리를 위하여 다음과 같이 개인정보 처리 업무를 위탁하고 있습니다.</div>
