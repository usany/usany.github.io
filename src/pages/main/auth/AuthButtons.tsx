  ...
  return (
    <div className='flex justify-center'>
      <div className='flex flex-col items-center justify-center w-[250px]'>
        {/* <AuthDialogs /> */}
        <Button className='colorTwo' startIcon={<img src={staticMicrosoft} className='w-[20px]' />} variant='outlined' onClick={onSocialClickMicrosoft}>
          마이크로소프트 로그인
          {/* <div className='truncate'>
          </div> */}
        </Button>
        <Button className='colorTwo' startIcon={<img src={staticGoogle} className='w-[20px]' />} variant='outlined' name='g' onClick={onSocialClickGoogle}>
          구글 로그인
          {/* <div className='truncate'>
          </div> */}
        </Button>
      ...
      <Button sx={{ width: '50%', backgroundColor: '#2196f3' }} startIcon={<img src={staticFacebook} className='w-[20px]' />} variant='outlined' onClick={onSocialClick}>
        ...
        <Button disabled className='colorTwo' variant='outlined' name='h' onClick={onSocialClick}>애플로 로그인</Button>
