...
const ProfileDialogs = ({
  ...
  const {
    currentImageWillBeDeletedWhenCharacterImagesAreSelected,
    uploadMyFile,
    save,
  } = useTexts()
    ...
    <>
      ...
      <div className="flex flex-col gap-1">
              ...
              <div
                ...
                onClick={() => {
                  ...
                  handleChangedImage({
                    ...changedImage,
                    attachment: '',
                    profileCharacter: index ? 'plant' : 'animal',
                    profileImage: false,
        ...
        <div className="flex justify-center h-5">
          <div
            className="flex justify-center rounded-xl w-10 bg-profile-red"
            onClick={() => switchColor('profileRed')}
          >
            {changedImage.profileColor === 'profileRed' && <Check />}
          </div>
          <div
            className="flex justify-center rounded-xl w-10 bg-profile-blue"
            onClick={() => switchColor('profileBlue')}
          >
            {changedImage.profileColor === 'profileBlue' && <Check />}
          </div>
          <div
            className="flex justify-center rounded-xl w-10 bg-profile-amber"
            onClick={() => switchColor('profileGold')}
          >
            {changedImage.profileColor === 'profileGold' && <Check />}
          </div>
        </div>
      </div>
