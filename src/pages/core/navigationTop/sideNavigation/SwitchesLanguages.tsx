...
const MaterialUISwitch = styled(Switch)(({ theme }) => ({
  ...
  '& .MuiSwitch-switchBase': {
    ...
    '&.Mui-checked': {
      ...
      '& + .MuiSwitch-track': {
        opacity: 1,
        backgroundColor: theme.palette.mode === 'dark' ? '#1a202c' : '#cbd5df',
      },
    },
  },
  '& .MuiSwitch-thumb': {
    // backgroundColor: theme.palette.mode === 'dark' ? '#3a4556' : '#f7fafb',
    backgroundColor: theme.palette.mode === 'dark' ? '#5c6778' : '#f7fafb',
    width: 32,
    height: 32,
    borderRadius: '5px',
    '&::before': {
...
export default SwitchesLanguages
